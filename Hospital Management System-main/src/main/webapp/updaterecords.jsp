...
<nav>
	...
	<form action="updatet" class="form1" method="post">
	<table>
		<tr>
			<td>Record ID</td>
		...
		<tr>
			<td>Patient ID</td>
			<td><input type="text" name="patient_id" value="<%=patient_id%>"></td>
		</tr>
		<tr>
		<td>Date Recorded</td>
		<td><input type="text" name="date_recorded" value="<%= date_recorded %>"></td>
	</tr>
	<tr>
		<td>Diagnosis</td>
	...
	<tr>
		...
		<td><input type="text" name="treatment_plan" value="<%= treatment_plan %>"></td>
	</tr>
	<tr>
		<td>Vital Signs</td>
		<td><input type="text" name="vital_signs" value="<%= vital_signs %>"></td>
	</tr>		
	</table>
	<br> 
	<input type="submit" name="submit" value="Update Medical Records"><br>
	</form>
